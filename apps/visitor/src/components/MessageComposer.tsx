...
export const MessageComposer = ({
  ...
  return (
    <div className="sticky bottom-0 z-10 border-t border-zinc-200 bg-white p-3 dark:border-zinc-700 dark:bg-zinc-950">
      ...
      <div className="mt-1 flex items-center justify-between text-[11px]">
        <span
          className={`min-h-4 ${error ? "text-red-600 dark:text-red-400" : "text-zinc-400 dark:text-zinc-500"}`}
          aria-live="polite"
        >
          {error ?? ""}
        </span>
